  ...
  @products.each do |product|
    product.product_details.where(sku_active: true).each do |product_detail|
      ...
      feed.entry product_detail, url: product_url do |entry|
        ...
        entry.tag!('g:image_link', @full_url_path + product.primary_image.image_url(:primary)) unless product.primary_image.blank?
        ...
        entry.tag!('g:identifier_exists', !product_detail.inventory_key.blank?)
